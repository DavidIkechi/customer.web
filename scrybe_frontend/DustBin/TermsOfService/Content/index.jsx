  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.paragraphs}>
        ...
        software, the download of product information, and the FAQs. Certain
        items, materials, services, information, or content on or accessible
        through this website may be subject to additional terms and conditions,
        as well as any transactions carried out using this website. These
        particular terms may be added on top of the Terms or, in the event that
        they conflict with the Terms, solely to the extent that the substance or
      ...
      <p className={styles.paragraphs}>
        ...
        specified, the material of this website may be reproduced, communicated,
        rebroadcast, published, or distributed in its entirety for personal,
        non-commercial use only, or with Scrybe full written authorization. All
        rights not specifically granted herein are retained, subject to the
        license below. On all copies, all copyright and other property markings
        must be maintained.
      </p>
      ...
      <p className={styles.paragraphs}>
        ...
        law, you may not translate, adapt, alter, modify, distribute, decompile,
        or reverse engineer that software for any purpose, produce any
        derivative works based on it, permit its combination with any other
        software, grant access to it, or use it to render services to third
        parties. Without our prior written authorization, you may not use the
        program in any way other than as permitted by these conditions. Extra
        terms and conditions may apply to your use of any services, software,
        information, or materials on the website. Scrybe will inform you of any
        additional terms and conditions at the time of download or access. You
        will be deemed to have accepted these extra conditions if you download
        or use the aforementioned services, information, or content. Please
        refrain from using the Services if you disagree with these extra terms
        and conditions.
      </p>
      ...
      <p className={styles.paragraphs}>
        ...
        made to ensure the accuracy of the material on this website, Scrybe
        makes no guarantees as a result. Scrybe hereby expressly disclaims any
        representations or warranties of any kind, express or implied, including
        without limitation warranties of merchantability, fitness for a
        particular purpose, non-infringement, or as to the operation of this
        website or the content. All content is provided "as is" and "as
        available." Regarding the security of this website, Scrybe neither
        guarantees it nor makes any assurances. You understand that any
        transmitted data might be intercepted. The website, the servers that
        host it, and any electronic communications transmitted by Scrybe are not
      ...
      <p className={styles.paragraphs}>
        ...
        business interruption) resulting from, arising from, or in connection
        with the use of, or inability to use, this website or the content, even
        if Scrybe has been advised of the possibility of such damages. Any
        action taken against Scrybe relating to or in connection with this
        website must be initiated and reported to Scrybe in writing within one
        (1) year of the occurrence of the cause of action. Nothing included in
        this disclaimer shall limit or exclude our responsibility for fraud, for
        wrongful death or bodily damage brought on by our carelessness, or for
        any other liability that cannot be restricted or excluded under
        applicable law.
      </p>
      ...
      <p className={styles.paragraphs}>
        ...
        these Terms will apply to the User who uses this website by connecting
        to it.
      </p>
      ...
      <p className={styles.paragraphs}>
        ...
        such websites and/or their content or is in any way associated with the
        linked website. Scrybe accepts no responsibility for the content of any
        linked website. It is your duty to read the terms and conditions of any
        other websites you visit. Scrybe has not examined, verified, monitored,
        or supported any additional links or resources given by the website and
      ...
      <p className={styles.paragraphs}>
        ...
        human rights or give rise to legal action in any jurisdiction because it
        is not defamatory, offensive, false, racially offensive, or incite
        racial hatred. Any consequences that may directly or indirectly result
        from posting such material on the website are solely your responsibility
        and not Scrybe's. Scrybe reserves the right to remove it from the site
        without notifying you and to cooperate with any investigation by the
        authorities or court order relating to it. You consent to defend and
        compensate Scrybe against any actions or repercussions that may occur in
        such situations, including any third-party claims. Furthermore, you
        guarantee that any information about any third party that you disclose
        to us—through email, form submission, use of an online chat service, or
        any other method—is correct and provided with the full knowledge and
        agreement of the person in question. Without incurring any obligation to
        you, Scrybe shall have the right to reveal your name to any third party
        who claims that any information or material submitted, posted or
        uploaded by you to the website violates their intellectual property
      ...
      <p className={styles.paragraphs}>
        ...
        Information' shall mean all non-public, confidential and proprietary
        information relating to the Parties, their respective clients and the
        Service, which has been or will be disclosed by a Party orally or as set
        forth in writing, or contained in some other tangible form. The
        receiving Party agrees to keep all Confidential Information disclosed by
        the disclosing Party in strict confidence and to use all rational
        efforts to keep it secret, and may not disclose Confidential Information
      ...
      <p className={styles.paragraphs}>
        ...
        receiving Party shall, immediately upon receiving notice that disclosure
        may be required, give written notice to the providing Party by printed
        and overnight mail so that the providing Party may seek a protective
        order or other remedy from said court or tribunal.In any case, the
        receiving Party shall only divulge that portion of the confidential
        information that, in the judgment of their legal counsel, is required by
        law to be disclosed, and will take all reasonable steps to ensure that
        any such information so disclosed will be treated confidentially by said
      ...
      <p className={styles.paragraphs}>
        ...
        providers, or affiliated firms, as applicable, who have all agreed to
      ...
      <p className={styles.paragraphs}>
        ...
        protect their own data, information, or other tangible or intangible
        property that they regard as proprietary or confidential. The receiving
        Party shall also take all reasonable steps to prevent their directors,
      ...
      <p className={styles.paragraphs}>
        ...
        Alternatively, the receiving Party may choose to eviscerate said
      ...
      <p className={styles.paragraphs}>
        ...
        restricted parts of our website or other material or Services, you must
        keep your user ID and password secret. You assume responsibility for all
        activities that take place using your user ID or password. If you
        violate any of the policies or agreements governing your use of our
        website, or any other contractual duty you owe to us, we may disable
