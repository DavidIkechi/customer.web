...
function Introduction() {
  return (
    <div className="sub-container">
      ...
      <p>
        Our Terms and Conditions ( <span>“Terms”</span> ) govern all use of our
        Service and together with the Privacy Policy constitutes your agreement
        with us ( <span>“agreement”</span> ).
      </p>
    </div>
  );
}
