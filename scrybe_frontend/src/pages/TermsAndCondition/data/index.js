...
export const termsData = [
  {
    title: "",
    content: "Welcome to Heed (“Company”, “we”, “our”, “us”)! ",
    conten:
  ...
  },
  {
    ...
    content:
      "Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Scrybe and its licensors. Service is protected by copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of Scrybe.",
  },
  {
    title: "Copyright and Other Intellectual Property",
    content:
      "The content contained on this Platform is owned or licensed by Scrybe and its third-party information providers and is protected by applicable copyrights, trademarks, service marks, and/or other intellectual property rights. Such content is solely for your personal, non-commercial use. Accordingly, in addition to specific restrictions outlined under clause 8.2, you may not copy, distribute, modify, post, frame or deep link this Platform, including any text, graphics, video, audio, software code, user interface design or logos.You may download material displayed on the Platform for your personal use provided you also retain all copyright and other proprietary notices contained on the materials.You may not distribute, modify, transmit, reuse, repost, or use the content on the Platform for public or commercial purposes, including all text, images, audio, and video.Modification or use of the materials for any other purpose violates Scrybe’s intellectual property rights.All trademarks, service marks, trade names, and logos displayed on the Platform are proprietary to Scrybe and/ or their respective owners.Nothing contained on the Platform should be construed as granting, by implication, estoppel, or otherwise, any license or right to use any trademark displayed on the Platform without the written permission of Scrybe or such other third party that may own the trademark displayed on the Platform.Your use of the trademarks displayed on the Platform, except as provided herein, is strictly prohibited.The use of the images displayed on the Platform by you, or anyone else authorized by you, is prohibited.Any unauthorized use of the images may violate copyright laws, trademark laws, and the laws of privacy and publicity, and communications, as well as other regulations and statutes.If you download any information from the Platform, you agree that you will not copy it or remove or obscure any copyright or other notices or legends contained in any such information.",
  },
  {
  ...
  },
  {
    title: "Termination",
    content:
      "We may terminate or suspend your account and bar access to Service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of Terms.You may terminate these Terms at any time by canceling your account on the Services.You will not receive any refunds if you cancel your account.You agree that Scrybe, in its sole discretion and for any or no reason, may terminate your account or any part thereof.You agree that any termination of your access to the Services may be without prior notice, and you agree that Scrybe will not be liable to you or any third party for such termination.You are solely responsible for exporting your User Content from the Services prior to termination of your account for any reason, provided that if we terminate your account, we will endeavor to provide you a reasonable opportunity to retrieve your User Content.Upon any termination of the Services or your account these Terms will also terminate, but all provisions of these Terms which, by their nature, should survive termination, shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, and limitations of liability.",
  },
  {
    title: "Governing Law",
    content:
