        ...
        <main className={styles.main}>
            <header className={styles.hero}>
                <div className={styles.text}>
                    ...
                    <p>Scrybe provides guaranteed 99% accurate transcripts and sentimental analysis with quick
 turnaround for customers large and small. That’s why we have the highest number of positie
reviews than any other transcription service around .</p>
                </div>
                <div className={styles.image}><img src={headerImg} alt="" /></div>
            </header>

            <section className={styles.first_title}>
                <h2>We are loved by Companies of all sizes</h2>
                <h3>Companies of all sizes from Startup and Fortune 500 companies use Scribe </h3>
            </section>

            <section className={styles.companies}>
                <div><img src={company1} alt="" /></div>
                <div><img src={company2} alt="" /></div>
                <div><img src={company3} alt="" /></div>
                <div><img src={company4} alt="" /></div>
                <div><img src={company5} alt="" /></div>
                <div><img src={company6} alt="" /></div>
            </section>
            ...
            <section className={styles.testimonial}>
                <div>
                    ...
                    <p>Scrybe has helped our business grow and expand as we have great insight into our
customer preferences</p>
                ...
                <div>
                    ...
                    <p>Scrybe has reduced the after call admin work and this saves a whole lot of time</p>
                </div>
                ...
                <div>
                    ...
                    <p>Captioning has been made a nightmare for me !!, and it took only few minutes to be
delivered by scrybe that’s incredible!!</p>
                </div>
                ...
                <div>
                    ...
                    <p>With the audio transcription and sentiment analysis,we are able to get feedback from our
clients and make necessary changes in a timely manner</p>
                </div>
            </section>
                ...
                <div className={styles.join_flex}>
                    ...
                    <div>
                        ...
                        <div className={styles.btns_btm}>
                            <button  className={styles.left_btn}>Try for free</button>
                            <button  className={styles.right_btn}>Login</button>
                        </div>
                    </div>
                </div>
            </section>
