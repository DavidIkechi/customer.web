        ...
        <div className={styles.signup}>
          ...
          <h3>Let’s get you started</h3>
            <form onSubmit={ handleSubmit(onSubmit) }>
              ...
              <input type="text" name="fullname" id="fullname" placeholder="Enter your full name" className={`${errors.fullname && styles.errorInput} `} {...register('fullname', {required:'Name is required'})}/>
              ...
              <input type="text" name="company" id="company" placeholder="Enter your company name" className={`${errors.company && styles.errorInput} `} {...register('company', {required:'Company name is required'})}/>
              <p className={styles.errorMsg}>{ errors.company?.message }</p>

              <label htmlFor="password">Password</label>
              <input type="password" name="password" id="password" placeholder="Enter your password" className={`${errors.password && styles.errorInput} `} {...register('password', {required:'Password is required', minLength:{value:8, message:"Password must be at least 8 characters"}})}/>
              <p className={styles.errorMsg}>{ errors.password?.message }</p>

              <input type="submit" disabled = {!isValid} value="Create an account" className={`${isValid && styles.submitValid}`} />
