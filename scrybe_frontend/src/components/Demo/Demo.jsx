        ...
        <div className={styles.demo_outer}>
          <div className={`${styles.demo_holder} ${styles.slidepage}`}>
            ...
            <div className={`${styles.demo_2} ${styles.demo}`}>
              ...
              <p>
                Your audio uploads are organized by <br/>Date of Upload and maximum
                upload size is 50mb
              </p>
            ...
            <div className={`${styles.demo_3} ${styles.demo}`}>
              ...
              <p>
                Barcharts help you check record of your total uploads; <br/>weekly
                and monthly
              </p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_5} ${styles.demo}`}>
              ...
              <p>
                Consists of the amount of agents in your team.<br/>Your plan
            ...
            <div className={`${styles.demo_6} ${styles.demo}`}>
              ...
              <h2>Transcription</h2>
              <p>
                Audios are transcribed into break points <br/>for easy access
                clarifications
              </p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_7} ${styles.demo}`}>
              ...
              <p>
                You can access your previous recordings <br/>with just one click.
              </p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_8} ${styles.demo}`}>
              ...
              <p>
                You can access your analysis <br/>with just one click.
              </p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_9} ${styles.demo}`}>
              ...
              <h2>Transcription</h2>
              <p>
                Sentiment analysis into three points: <br/>Positive, Negative and
                Neutral.
              </p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_10} ${styles.demo}`}>
              ...
              <p>
                Access to quantitive break down of overall sentiment <br/>based on
                audio uploaded
              </p>
              <div className={styles.navigation}>
                <button
            ...
            <div className={`${styles.demo_11} ${styles.demo}`}>
              ...
              <p>Customer satisfaction automatically <br/>measured and accessed.</p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_12} ${styles.demo}`}>
              ...
              <p>Download verdict in your preferred format: <br/>pdf, html, Json.</p>
              <div className={styles.navigation}>
                <button 
            ...
            <div className={`${styles.demo_13} ${styles.demo}`}>
              ...
              <p>What next? <br/>You can test it out using the button below.</p>
              <div className={styles.navigation}>
                <button 
